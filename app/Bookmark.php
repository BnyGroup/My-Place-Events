...
class Bookmark extends Model
{
    ...
    public function getlists($id) {
        return static::select('event_bookmark.*','events.*')
        ->join('events','events.event_unique_id','=','event_bookmark.event_id')
        ->where('event_bookmark.user_id',$id)
        ->paginate(15);
    }
    public function getUserBook($id) {
        return static::select('event_bookmark.*','frontusers.firstname as fnm','frontusers.lastname as lnm','frontusers.email as mail')
        ->join('frontusers','frontusers.id','=','event_bookmark.user_id')
        ->where('event_id',$id)
        ->get();
    }
...
/* ==================================================================================== */
/* ==================================================================================== */
    /*Book mark or save  event for api*/
