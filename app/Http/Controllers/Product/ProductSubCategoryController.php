...
class ProductSubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.products.subcategory.all', compact('all_category', 'all_subcategory'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return $product_category->id
            ? back()->with(FlashMsg::create_succeed(__('Sous-Catégorie de Produits enregistrée avec succès')))
            : back()->with(FlashMsg::create_failed(__('Echec enregistrement Sous-Catégorie de Produits')));
    }
    ...
    public function update(Request $request, ProductSubCategory $productSubCategory)
    {
        ...
        return $updated
            ? back()->with(FlashMsg::update_succeed(__('Sous-Catégorie de Produits mis à jour avec succès')))
            : back()->with(FlashMsg::update_failed(__('Echec mise à jour de la Sous-Catégorie de produits')));
    }
    ...
    {
        $item->delete();
		return back()->with(FlashMsg::update_succeed(__('Sous-Catégorie supprimée avec succès')));
    }
