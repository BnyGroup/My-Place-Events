...
class TagController extends Controller
{
    ...
    {
        $all_tag = Tag::all();
        return view('Admin.products.tag.all-tag', compact('all_tag'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return $updated
            ? back()->with(FlashMsg::update_succeed(__('Tag mis à jour avec succès')))
            : back()->with(FlashMsg::update_failed(__('Echec mise à jout du Tag')));
    }
