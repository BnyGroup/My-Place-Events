...
class CinetPay
{
    ...
    public function getPayButton($formName, $btnType = 1, $size = "large")
    {
        ...
        $form .= "<p>Veuillez patienter 5 seconde avant la redirection svp</p>";
        $form .= "</form>";
//        $form .= "<script type='text/javascript'>function miseenattente(){ setTimeOut(fonctionAExecuter, 5000); } function fonctionAExecuter(){ /*window.document.forms.submit();*/  document.getElementsByClassName('cpButton').click();} miseenattente();</script>";
        return $form;
    }
