        ...
        <div class="col-md-12 user-events" style="border-top: 1px solid #dfdfdf;">
            <div class="row">
                ...
                <div class="col-lg-10 col-12">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-heading" align="center">@lang('words.mng_eve.mng_gad_tit')</h2>
                        </div>
                                    ...
                                    <div class="card-block mb-5">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab-7">
                                                ...
                                                @if(!empty($uGadgets) && count($uGadgets) > 0)
                                                <div class="row">
                                                    @foreach($uGadgets as $event)
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">

                                                        <div class="card mb-4">
                                                            <!--Badges-->
                                                            @if(Carbon\Carbon::today()->format('Y-m-d') == Carbon\Carbon::parse($event->item_start_datetime)->format('Y-m-d'))
                                                            <span class="badge badge-pill badge-primary label-float-l" style="background-color: #007bff; color:white">Aujourd'hui</span>
                                                            @elseif(Carbon\Carbon::today()->format('Y-m-d') < Carbon\Carbon::parse($event->item_start_datetime)->format('Y-m-d'))
                                                            ...
                                                            @endif
                                                                ...
                                                                @endif
                                                                        <!--Badges-->
                                                              <a href="{{ route('events.details',$event->item_slug) }}" target="_blank"><img class="card-img-top" src="{{ getImage($event->item1_image, 'thumb') }}" alt="{{ $event->item_name }}"></a>
                                                            <div class="card-body text-center">
                                                                <h5 class="card-title">{{ $event->item_name }}</h5>
                                                                <p class="card-text mb-2">
                                                                    <small>
                                                                        <i class="far fa-clock"></i>
                                                                        {{ /*Carbon\Carbon::parse($event->item_start_datetime)->format('D, F j, Y')*/ ucwords(Jenssegers\Date\Date::parse($event->item_start_datetime)->format('l j F Y')) }}
                                                                        à
                                                                        {{ Carbon\Carbon::parse($event->item_start_datetime)->format('H:i') }}
                                                                    </small>

                                                                </p>
                                                                <a href="{{ route('shop.item.dshaboard',$event->item_unique_id) }}" class="btn btn-primary btn-sm"><i
                                                                            class="fa fa-cog"></i> @lang('words.mng_eve.mng_eve_mng')</a>
                                                                <a href="{{ route('shop.item.edit',$event->item_unique_id) }}" class="btn btn-primary btn-sm"><i
                                                                            class="fa fa-edit"></i> @lang('words.mng_eve.mng_eve_edt')</a>
                                                                <a href="{{ route('shop_item.details',$event->item_slug) }}" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-eye"></i> @lang('words.mng_eve.mng_eve_vew')</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                                ...
                                                                <div class="card mb-4">
                                                                    ...
                                                                    @if($event->ban == 1)
                                                                        ...
                                                                        <div class="card-body text-center">
                                                                            ...
                                                                            <a href="{{ route('events.dshaboard',$event->item_unique_id) }}" class="btn btn-primary btn-sm"><i
                                                                                        class="fa fa-cog"></i> @lang('words.mng_eve.mng_eve_mng')</a>
                                                                            <a href="{{ route('events.edit',$event->item_unique_id) }}" class="btn btn-primary btn-sm"><i
                                                                                        class="fa fa-edit"></i> @lang('words.mng_eve.mng_eve_edt')</a>
                                                                            <a href="{{ route('events.details',$event->item_slug) }}" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-eye"></i> @lang('words.mng_eve.mng_eve_vew')</a>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                                                ...
                                                                <div class="card mb-4">
                                                                    ...
                                                                    @if($event->ban == 1)
                                                                        ...
                                                                        @endif
                                                                                <!--Badges-->
                                                                        <a href="{{ route('events.details',$event->item_slug) }}" target="_blank">  <a href="{{ route('events.details',$event->item_slug) }}" target="_blank"><img class="card-img-top" src="{{ getImage($event->item1_image, 'thumb') }}" alt="{{ $event->item_name }}"></a></a>
                                                                        <div class="card-body text-center">
                                                                            <h5 class="card-title">{{ $event->item_name }}</h5>
                                                                            <p class="card-text mb-2">
                                                                                <small>
                                        ...
                                        {{--@if(!empty($uEvents) && count($uEvents) > 0)--}}
                                            {{--<div class="eventbox-events">--}}
                                                {{--@foreach($uEvents as $event)--}}
                                                    {{--<div class="eventbox">--}}
                                                        {{--<h3 class="event-title wordwap">{{ $event->item_name }}</h3>--}}

                                                        {{--<p class="event-time">--}}
                                                            {{--{{ Carbon\Carbon::parse($event->item_start_datetime)->format('D, F j, Y') }}--}}
                                                            {{--at--}}
                                                            {{--{{ Carbon\Carbon::parse($event->item_start_datetime)->format('h:i:A') }}--}}
                                                        {{--</p>--}}

                                                        {{--<div class="event-link">--}}
                                                            {{--<a href="{{ route('events.dshaboard',$event->item_unique_id) }}"><i--}}
                                                                        {{--class="fa fa-cog"></i> @lang('words.mng_eve.mng_eve_mng')--}}
                                                            {{--</a>--}}
                                                            {{--<a href="{{ route('events.edit',$event->item_unique_id) }}"><i--}}
                                                                        {{--class="fa fa-edit"></i> @lang('words.mng_eve.mng_eve_edt')--}}
                                                            {{--</a>--}}
                                                            {{--<a href="{{ route('events.details',$event->item_slug) }}"><i--}}
                                                                        {{--class="fa fa-eye"></i> @lang('words.mng_eve.mng_eve_vew')--}}
                                                            {{--</a>--}}
                                                            {{--<a href="{{ route('events.refund',[$event->item_unique_id,'pending']) }}"><i--}}
