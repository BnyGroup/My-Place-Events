...
<div class="page-main-contain">
    ...
    <section class="user-events" style="padding-top: 0;">
        <div class="container">
            ...
            @endif
            <h2 class="text-heading mb-4">@lang('words.manage_dash.mng_dash_tit')</h2>
                    ...
                    <div class="card">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <img src="{{ getImage($event->event_image, 'thumb') }}" class="card-img-top"
                                alt="...">
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $startdate 	= ucwords(Jenssegers\Date\Date::parse($event->event_start_datetime)->format('l j M Y'));
                                        $enddate 	= ucwords(Jenssegers\Date\Date::parse($event->event_end_datetime)->format('l j M Y'));
                                        ...
                                        <div class="dropdown mt-3">
                                            <a href="{{ route('events.edit',$event->event_unique_id) }}">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            href="{{ route('events.details',$event->event_slug) }}"><i
                                            class="fa fa-eye"></i> @lang('words.mng_eve.mng_eve_vew')
                                        </a>
                                        <a class="dropdown-item"
                                        href="{{ route('events.delete',$event->event_unique_id) }}"
        ...
        <!--Type de tickets-->
        <div class="col-md-4 Tickets_Block">
            <div class="tickets-type">

                <div class="card">
                    <h5 class="card-header">@lang('words.manage_dash.mng_tik_toal')<span>@lang('words.manage_dash.mng_tik_toalspan')</span></h5>
                    <div class="card-body">
                        @php
                        ...
                        <div class="progess-text">
                            <strong>{{ $totalOrderTickss->TOTAL_ORDER_TICKETS }}</strong> @lang('words.manage_dash.mng_sol_toalfist')
                        ...
                        <div class="progress">
                            ...
                            @php
                            $total = number_format(($ticket->NUMBER_OF_CHACKIN /
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="progess-text">
                            <strong>{{($ticket->NUMBER_OF_CHACKIN)}}</strong> @lang('words.manage_dash.mng_sol_toal')
...
<div class="row mb-5">
    <div class="col-md-12" align="center">
        <center>
            <a href="{{ route('events.attendee', $event->event_unique_id) }}"
                       ...
                       <div class="row">
                           <div class="col-md-12">
                               ...
                               <div class="header1">
                                    ...
                                    <span>
                                        @lang('words.manage_dash.eve_ttl_sell')
                                    </span>
                                    
                                    <td class="text-center">
                                    
                                        @if(!empty($totalSoldTickets))
                                        {{ $totalSoldTickets }}
                                        @else
                                        0
                                        @endif
                                ...
                                <div class="header1">
                                    <span>
                                        @lang('words.manage_dash.ch_aff_ttl')
                                    </span>
                                    
                                    <td class="text-right">

                                        @if(!empty($event_tickets))
                                        {!! use_currency()->symbol !!} {{ $event_tickets }}
                                        @else
                                        0
                                        @endif
                                                           ...
                                                           <div class="modal-body">
                                                               <div class="text-body">
                                                                   <p>
                                                                       ...
                                                                       - {{ date_format($val->created_at,'d M, Y  h:i A') }}
                                                                   </p>
                                                           ...
                                                           <td>{{ $attenkets->TICKE_QTY - $attenkets->ticket_remaning_qty }}
                                                               ...
                                                               <td>
                                                                   @if($attenkets->TICKE_PRICE_ACTUAL > 0)
                                                                   	 {{ $attenkets->TICKE_PRICE_ACTUAL }} {{ use_currency()->symbol }}
                                                                   @else
                           ...
                           <div class="col-md-12">
                               <div class="tickets-type">
                                   ...
                                   <div class="iframe-snip">
                                       <iframe src="{{ route('snippet.event',\Crypt::encrypt($event->event_slug)) }}"
                                       ...
                                       <div class="">
                                           ...
                                           &lt;iframe
                                           src="{{route('snippet.event',Crypt::encrypt($event->event_slug))}}"
                       ...
                       <div class="row">
                           <div class="col-md-12">
                               <div class="tickets-type">
                                   ...
                                   @if(! is_null($event->event_link_slug))
                                   <label class="text-uppercase label-text">Link:</label>
                                   <div id="link-status">
                                       <a href="{{ route('custom.slug',$event->event_link_slug) }}"
                                        target="_blank">{{ route('custom.slug',$event->event_link_slug) }}</a>
                                    </div>
                                    @else
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="event_link_slug" class="form-control form-textbox"
                                        id="basic-url" aria-describedby="basic-addon3"
                                        value="{{ $event->event_link_slug }}">
                                    </div>
                                    <input type="submit" name="send" id="linkgenerate" value="Générer"
                                    class="btn btn-primary form-textbox" data-id="{{ $event->id }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    {{--<div class="col-lg-3 col-md-4 col-sm-12">--}}
        {{--<div class="event-sidebar">--}}
            {{--<ul class="nav nav-tabs text-capitalize">--}}
                ...
                {{--</li>--}}
            {{--</ul>--}}
            {{--<div><a href="{{ route('events.attendee', $event->event_unique_id) }}"--}}
...
<script type="text/javascript">
    ...
    $('body').on('click', '#linkgenerate', function () {
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {_token: "{{ csrf_token() }}", event_link_slug: basicurl, id: id},
