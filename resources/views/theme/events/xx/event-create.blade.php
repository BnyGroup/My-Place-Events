		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12 col-sm-12 about-parents-wrapper-min">
					<h2 class="text-uppercase about-title">@lang('words.cre_eve_page.cre_pg_tit')</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row page-main-contain boxed-box">
			<section class="secondary-bg alert-commision">
				...
				<!--
				<br>
				<em>(Ex : {!! number_format($exemple*event_commission()/100, 0, "."," ") !!} F seront prélevés sur un ticket de {!! number_format($exemple, 0, "."," ") !!} F. Le reste, soit {!! number_format($exemple - ($exemple*event_commission()/100) , 0, "."," ") !!} F, vous revient)</em>
				-->
			</section>
			...
			<div class="col-md-12">
				...
				<h2 class="profile-title profile-title-text page-header">@lang('words.cre_eve_page.cre_ev_detils')</h2>
				<br/>
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-md-12 form-group">
						...
						<input type="text" name="event_name" id="event_name" class="form-control form-textbox" value="{{ Input::old('event_name') }}" required/>
						@if($errors->has('event_name')) <span class="error">{{ $errors->first('event_name') }}</span> @endif
					</div>
	<!--
					<div class="col-lg-12 col-sm-12 col-md-12 form-group">
						<label class="label-text">Couleur du texte <span class="text-danger"></span></label>
						<input type="text" name="color" id="color1" value="#269faf" class="form-control form-textbox" value="{{ Input::old('color') }}" />
						@if($errors->has('color')) <span class="error">{{ $errors->first('color') }}</span> @endif
					</div>

					<div class="col-lg-12 col-sm-12 col-md-12 form-group">
						<label class="label-text">Couleur de fond<span class="text-danger"></span></label>
						<input type="text" name="background" id="color2" value="#269fff" class="form-control form-textbox" value="{{ Input::old('background') }}" />
						@if($errors->has('background')) <span class="error">{{ $errors->first('background') }}</span> @endif
					</div>
	-->miezan bonjour
					<div class="col-lg-12 col-sm-12 col-md-12 form-group">
					...
					<!-- START DATE AND TIME -->
					<div class="col-lg-12 col-sm-12 col-md-12 form-group" >
						<label class="label-text">@lang('words.cre_eve_page.cre_fm_img') <span class="text-danger">*</span></label>
						<div class="form-textbox" style="padding-left: 0;" align="center">
							...
							<input type="file" name="event_image" id="imgInp"  style="display: none;" accept="image/x-png,image/gif,image/jpg" required=""/><br /><br />
					...
					<div class="col-lg-12 col-md-12 col-sm-12 form-group">
						...
						@foreach ($pays as $paysLists)
								<option <?php 
										if(Input::old('nom_pays') == $paysLists['id_pays']){ echo 'selected="selected"'; }
				...
				<div class="row">
					...
					<!-- commnt -->
						...
						<div class="col-lg-12 form-group" align="center">
							<input type="Submit" value="@lang('words.cre_eve_page.add_seeting_btn')" class="pro-choose-file" />
						</div>
	...
	<div style="display: none;" class="ticket-label">
		...
		<div class="addeventtickets">
			...
			<div class="col-md-3 form-group">
				<label class="ticket-label">{{--Ticket Qty--}}Nombre du Ticket</label>
