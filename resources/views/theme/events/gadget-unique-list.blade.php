    ...
    <div class="box" style="position: relative;">
        ...
        <div class="box-content card__padding">
            <h4 class="card-title"><a
                        href="{{ route('shop_item.details',$data->item_slug) }}">{{ $data->item_name }}</a>
            </h4>
            ...
            <div class="card__action">
                ...
                <form action="{{route('shop_cart.store')}}" method="POST">
                    ...
                    <div class="col-sm-12" style="height:50px;line-height:36px;margin-top:20px" >
                        <button href="#" type="submit" class="btn no-rad secondary-bg" style="color:#000D8C;width:100%">@lang('words.cre_gad_page.add_to_cart')</button>
                    </div>
                </form>
            </div>
