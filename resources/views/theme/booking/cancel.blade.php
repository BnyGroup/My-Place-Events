				...
				<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12 book-box-inner">
					<div class="row">
						...
						<div class="col-md-5 col-lg-4 col-sm-12 col-xs-12 book-btn" style="text-align: center; margin: 0px auto;">
							<a href="{{ route('events.details',$bookingdata->event_slug) }}" class="pro-choose-file btform1 text-uppercase">@lang('words.events_booking_page.eve_book_bookingCancelback')</a>
						</div>
					</div>
				</div>
			</div>
