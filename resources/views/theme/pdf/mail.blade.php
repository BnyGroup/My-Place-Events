		...
		<div class="mail-inner-content">
			...
			<div class="mail-header">
				<div class="mail-logo" style="position: relative;display: flex;justify-content: space-around;bottom:30px;">
					...
					<h1>@lang('words.mail_tmp.eve_titl') - {{ $orderData->event_name }}</h1>
				</div>
			</div>
			...
			<div class="mail-body">
						...
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" id="mes_mesge_imgevent" style="display: flex;justify-content: space-around;top: 50px;right: 150px">
							<h2 id="message1" style="position: relative;top:60px;font-size: 2em; right: 20px;" > Salut <span style="color: #FF33D1"> 
								{{guestUserData($orderData->gust_id)->name}} </span> , ceci est <br> ta confirmation de commande <br> pour :<br> 
								<span style="position:relative; top: 10px; color: #1531B0; font-size: 20px">{{ $orderData->event_name }}</span> 
							</h2>
						...
						<div id="trait_org" style="position: relative;bottom: 100px;">
						<div id="mon_trait" style="position: relative;bottom: 50px;"> <hr style="border: none; border-top: 2px dashed #000; width: 50%; margin: 20px 0;"> </div>
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" id="nom_org" style=" position: relative;bottom: 50px">
...
?>										
			...
			<!-- 	<div >
					<a href="{{ url('/public/upload/ticket-pdf/') }}"  class="primary" style="text-decoration: none;" >
                    <button class="favorite styled" type="button" style="text-decoration: none; position:relative; left:35%; margin-top: 15px; margin-bottom: 15px; display: block; width: 30%; height: 70px; background-color: #EBAE15; border: none; outline: none;border-radius: 15px 15px 15px 15px;" >
						<a href="{{ url('/public/upload/ticket-pdf/') }}"  class="primary" style="text-decoration: none;" > 
							<h4 style="color: black; font-size: 1.8em; font-weight: bold;">TELECHARGE TON E-TICKET</h4> 
						</a> 
					</button>
				    ...
				    <div style="position:relative;text-align: center;"> <p>Tu peux conserver ton e-ticket dans ton téléphone <br> ou l’imprimer et le présenter le jour de l’événement.</p> </div>  
				<!-- -->
