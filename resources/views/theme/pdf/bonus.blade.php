...
<head>
	...
	<title>{{ forcompany() }} - Deposit sur votre Wallet E-Dari</title>
	<style type="text/css">
		@font-face {
		...
		<div class="mail-inner-content">
			...
			<div class="mail-header">
				...
				<div class="mail-header-title" >
					<h1>@lang('words.mail_tmp.eve_titl2')</h1>
				</div>
			</div>
			<div class="mail-body">
				<div class="body-title">
					<h4>
						@lang('words.mail_tmp.hi_hello') <span>
							@if(auth('frontuser')->check())
							{{ $bookingdata->fnm }} {{ $bookingdata->lnm }}
							@else
								{{guestUserData($bookingdata->gust_id)->name}}
							@endif
						</span>, @lang('words.mail_tmp.eve_titl3') <br/><span> {{ $lastAmountFromDefaultWallet }} F CFA @lang('words.mail_tmp.eve_titl4')       <a href="{{ route('users.pro') }}/bonus" target="_blank" > Wallet E-Dari </a>
	        			</p></span>
					</h4>
                    <p class="term-service">
	            		@lang('words.mail_tmp.eve_titl5')
	        		</p>
				...
				<div class="order-summary">
					...
					<div class="order-body">
						<img style="max-width:100%" data-imagetype="External" src="https://myplace-events.com/public/img/CONGRATULATE.jpg" alt="My Place Events">
						<div class="bottom-dashed"></div>
						<p class="term-service">
	            			@lang('words.pdf.sum_ord_2') <a href="https://myplace-events.com/fr/pages/conditions-generales-dutilisation/" target="_blank" >@lang('words.mail_tmp.terms_ser')</a>  @lang('words.mail_tmp.org_tik_an')
	            			<a href="https://myplace-events.com/fr/pages/politique-de-confidentialite-des-donnees-personnelles" target="_blank" >@lang('words.mail_tmp.terms_se2')</a>
	        			</p>
					</div>
				</div>
			</div>
