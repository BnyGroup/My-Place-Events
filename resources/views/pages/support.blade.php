...
@section('meta_title',setMetaData()->page_title.$data['support-page-title']['value'])
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12 col-sm-12 about-parents-wrapper-min">
					<h2 class="text-uppercase about-title col-lg-6">{!! $data['support-page-title']['value'] !!}</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-md-12 col-lg-12 parent-about-content">
				{!! $data['support-page-content']['value'] !!}
			</div>
		</div>
	</div>
