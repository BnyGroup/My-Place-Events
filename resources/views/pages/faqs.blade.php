...
@section('meta_title',setMetaData()->page_title.$data['faqs-page-title']['value'])
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12 col-sm-12 about-parents-wrapper-min">
					<h2 class="text-uppercase about-title">{!! $data['faqs-page-title']['value'] !!}</h2>
				</div>
			</div>
		</div>
	</div>
