...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>{{--Password Reset--}}Réinitialiser le mot de passe </title>
    ...
    <div class="login-box-body">
        <p class="login-box-msg">{{--Password reset Enter your Email--}}Mot de passe réinitialisé Entrez votre email</p>
         ...
         {!! Form::close() !!}
         <br>
    	<a href="{{ route('login') }}" class="btn btn-default btn-flat btn-sm btn-block">{{--Back--}}Retour</a>
    </div>
</div>
