...
@section('content-header')
	<h1>Paramètres de Page {{--Settings --}}</h1>
	<ol class="breadcrumb">
...
@section('content')
	...
	<div class="box-header with-border">
		<h3 class="box-title">{{--Page Setting--}}Paramètres de Page</h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
		...
		<div class="row">
			<div class="col-md-8 col-lg-8 col-sm-8">
				<div class="form-group">
					<label for="firstname" class="control-label">{{--Title--}}Titre :</label>
					{!! Form::text('page_title','',['class'=>'form-control','placeholder'=>'Title' ,'autofocus','id'=>'page_title']) !!}
					@if ($errors->has('page_title'))<span class="help-block"><strong><font color="red">{{ $errors->first('page_title') }}</font></strong></span>@endif
				</div>
				<div class="form-group">
					<label class="form-label" for="desc">Description de Page :</label>
					{!! Form::textarea('page_desc','', array('class' => 'form-control summernote','id' => 'page_desc')) !!}
					@if ($errors->has('page_desc'))<span class="help-block"><strong><font color="red">{{ $errors->first('page_desc') }}</font></strong></span>@endif
				</div>
			</div>
			<div class="col-md-4 col-lg-4 col-sm-4">
				<div class="form-group">
					<label for="img">Status de la Page:</label> <br>
					<label for="active">
						<input type="radio" name="page_status" value="1" checked="" id="active"> Active
					</label>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
					<label for="dactive">
						<input type="radio" name="page_status" value="0" id="dactive"> Desactive
					</label>
				...
				<div class="form-group">
					<label>{{--Keyword--}}Mot Clés :</label> <br>
