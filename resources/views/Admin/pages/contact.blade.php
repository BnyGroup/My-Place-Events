...
<h1>{{--Contact Page--}}Page de Contact</h1>
<ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> {{--Home--}}Accueil</a></li>
	<li><a href="#">{{--Contact page--}}Page de Contact</a></li>
</ol>
@endsection
@section('content')
		...
		<div class="row">
			...
			{!! Form::open(array('route' => 'contact.update','autocomplete'=>'off','files'=>'true','method'=>'post')) !!}
				...
				<div class="form-group">
					...
					{!! Form::text($settings['contact-page-location']['slug'], $settings['contact-page-location']['value'], array('class' => 'form-control','id'=>'location')) !!}
