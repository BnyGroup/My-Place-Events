    ...
    <div class="mail-inner-content">
        ...
        <div class="mail-header">
            ...
            <div class="mail-header-title" >
                <h1>Ticket(s) payé(s)</h1>
            </div>
        </div>
        <div class="mail-body">
            <div class="body-title">
                <h4>
                    "Le paiement de la commande <strong>"  {{ $orderData['bookingdata']->order_id }}"</strong> s'est effectué avec succès !<br>
                    <h3 style="text-align: center"> Détails de la transaction </h3>
                    <p style="font-size: 1.5em">
                        Nom de l'événement :{{ ($orderData['event'] == null)?'':$orderData['event']->event_name }}<br>
                        Nombre de Ticket(s) : {{ $orderData['bookingdata']->order_tickets }}<br>
                        Montant : {{ number_format($orderData['bookingdata']->order_amount,0,',',' ') }} <br>
                        CellPhone : {{ $orderData['user']->cellphone }} <br>
                        Email Acheteur principal : {{ ($orderData['bookingdata']->user_id == 0)?$orderData['user']->guest_email : $orderData['user']->email }}
                    </p>
                </h4>
