    ...
    <div class="mail-inner-content">
        ...
        <div class="mail-body">
            <div class="body-title">
                <h4>
                    "Une demande de livraison de ticket.s <strong>" {{ $orderData->order_id }}"</strong> vient d'être éffectuée !<br>
                    <h3 style="text-align: center"> Détails </h3>
                    <p style="font-size: 1.5em">
                        Nom de l'événement :{{ ($orderData->event_name == null)?'':$orderData->event_name }}<br>
                        Nombre de Ticket(s) : {{ $orderData->order_tickets }}<br>
                        <?php
                            ...
                            ?>
                                <?= $qty ?> Ticket(s) de <?= $ticket_price[$i]." FCFA <br>" ?>
                            <?php
                            $i++;
                            }
                        ?>
                        Montant : {{ $orderData->order_amount }} FCFA<br>
                        Cellphone : {{ ($orderData->ot_cellphone == null)?$orderData->cellphone:$orderData->ot_cellphone }} <br>
                        Email Acheteur principal : {{ ($orderData->user_id == 0)?$orderData->ot_email: $orderData->user_email }}
                    </p>
                </h4>
