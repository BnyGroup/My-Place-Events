...
<h1>Liste des Bannières les immanquables</h1>
@endsection
@section('content')
<div class="box box-primary">
	<div class="box-header">
		<h3 class="box-title">Gestion des Bannières les immanquables</h3>
	</div>
	<!-- /.box-header -->
	<div class="box-body">
					...
					<tr>
						...
						<td>
							...
							@permission('admin-user-delete')
								@if($val->id != 1)
									<a href="{{ route('admin.bannerimmanquables.delete',$val->id) }}" class="btn btn-danger btn-flat" onclick=" return confirm('Êtes-vous sûr de vouloir supprimer cette bannière ?')">Supprimer <i class="fa fa-trash"></i></a>
								@endif
							@endpermission
...
<div class="modal" tabindex="-1" role="dialog" id="BannerModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="{{ route('admin.bannerimmanquables.add') }}" method="POST" enctype="multipart/form-data">
...
<div class="modal" tabindex="-1" role="dialog" id="EditBannerModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <form action="{{ route('admin.bannerimmanquables.edit') }}" method="POST" enctype="multipart/form-data">
     <input type="hidden" name="_token" value="{{ csrf_token() }}">
